...
async function loadCardano() {
    ...
    if (!nami) {
        ...
        const lucid = await L.Lucid.new(
            new L.Blockfrost("https://cardano-preview.blockfrost.io/api/v0", "previewKvMro43GCq0CwMO4AeuA6BVo4m7SynYF"),
            "Preview",
        );
...
async function getCardanoPKH() {
    ...
    console.log("Cardano hash: " + details.paymentCredential.hash);
